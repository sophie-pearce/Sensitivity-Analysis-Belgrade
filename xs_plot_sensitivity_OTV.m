...
% This script is used to reproduce Figure 7c and 7d within the research
...
% In the folder: Sensitivity_Analysis\Inputs\OTV_VideoA - all inputs in
...
% Alter the inputs
dirName = 'F:\Year 3\BelgradeData_toUpload\ToUpload\Sensitivity_Analysis\Inputs\OTV_VideoA\';
%
...
for aa = 1:length(fileNameIn)
    ...
    %OTV inputs
    allXY = [otvXtransGrid(:),optvYtransGrid(:)]; % exported x y grid for PTV
    uOut = zi; % PTV out
