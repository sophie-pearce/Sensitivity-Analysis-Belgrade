...
% Outputs: 
% This script will produce the velocities and locations of the LSPIV surface
% velocities, in comparisons to the ADCP measurements. 

%Inputs: 
% You will need the LSPIV data for each video (to be run seperately)
...
dirName = 'F:\Year 3\BelgradeData_toUpload\ToUpload\ADCP_Comparisons\LSPIV';
...
for aa = 1
    ...
    pathIn = strjoin({'F:\Year 3\BelgradeData_toUpload\ToUpload\ADCP_Comparisons\LSPIV\', char(fileNameIn(aa,1))},'');
